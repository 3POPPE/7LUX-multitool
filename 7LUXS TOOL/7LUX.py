...
def main():
    ...
    {Fore.RED}                                     _____ ____  ____   ___  ____   _____{Fore.RESET}
    {Fore.RED}                                    | ____|  _ \|  _ \ / _ \|  _ \ |__  /{Fore.RESET}
    {Fore.RED}                                    |   _|| |_) | |_) | | | | |_) |  / / {Fore.RESET}
    {Fore.RED}                                    | |___|  _ <|  _ <| |_| |  _ <  / /_ {Fore.RESET}
    {Fore.RED}                                    |_____|_| \_\_| \_\\___/|_| \_\/____|{Fore.RESET}
               ''')

    time.sleep(2)
    slowprint(
        f'{Fore.LIGHTBLACK_EX}Made by: {Fore.RESET}{Fore.RED}7LUX{Fore.RESET}', .02)
    time.sleep(1)
...
def terminate():
    ...
    while True:
        ...
        if stuff['code'] == 0:
            ...
            print("Disabler by HARM and 7LUX")
            time.sleep(2)
            break
            main()
